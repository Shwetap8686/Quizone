  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="brown" data-background-color="white" data-image="../Project/admin_dashboard/assets/img/sidebar-3.jpg">
      ...
      <div class="sidebar-wrapper">
          <ul class="nav">
              <li class="nav-item  ">
                <a class="nav-link" href="../Project/userdashboard.html">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;" style="font-family: Roboto Slab; font-size: 26px">User Profile</a>
          </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <a class="dropdown-item" href="../Project/user_settings.php">Settings</a>
